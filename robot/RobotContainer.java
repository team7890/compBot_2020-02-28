...
import frc.robot.commands.AutoLaunchAndMove;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    objDriveTrain.setDefaultCommand(
        new DriveRobot(() -> -objXboxDriverStick.getRawAxis(1), () -> objXboxDriverStick.getRawAxis(4), objDriveTrain, () -> objXboxDriverStick.getRawAxis(2)));
  ...
  private void configureButtonBindings() {
    ...
    buttonDriverA.whileHeld(new FeedLauncherSlowly(objFeeder));
  ...
  // return new RaiseFloor(objFloor);
    ...
    () -> {return -0.5;}, () -> {return 0.0;}, objDriveTrain, objIntake, objIntakeMotor, () -> {return 1.0;});
