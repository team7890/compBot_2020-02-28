...
public class LaunchInLow extends SequentialCommandGroup {
  ...
  DoubleSupplier dSpeedIn, DoubleSupplier dTurnIn, DriveTrain objDriveTrain, DoubleSupplier dsSlowDownIn) {
    addCommands(
      ...
      new DriveRobot(dSpeedIn, dTurnIn, objDriveTrain, dsSlowDownIn).withTimeout(2.0)
    );
